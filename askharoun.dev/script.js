document.addEventListener("DOMContentLoaded", () => {
  ...
  if (typewriterText) {
    const phrases = ["Electrical Engineer", "Problem Solver", "Tech Enthusiast", "Check the Website Out!"]
    let phraseIndex = 0
    let charIndex = 0
  ...
  const animatedElements = document.querySelectorAll(
    ".section-title, .experience-card, .project-card, .cert-card, .about-content, .content-section",
  )
