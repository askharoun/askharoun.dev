...
const DICTIONARY = {
    en: {
        ...
        notify_success: "Reminders enabled! We will remind you to read daily.",
    ...
    ar: {
        ...
        notify_success: "تم تفعيل التذكيرات! سنذكرك بالقراءة يومياً.",
...
function showGreeting() {
    document.getElementById('greeting-banner').innerText = DICTIONARY[currentLang].greeting;
}
    ...
    btn.addEventListener('click', () => {
        Notification.requestPermission().then(perm => {
            if (perm === 'granted') {
                ...
                new Notification("Bible Plan", { 
                    body: DICTIONARY[currentLang].notify_success,
